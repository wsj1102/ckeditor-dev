...
* [#2307](https://github.com/ckeditor/ckeditor-dev/issues/2307): Implemented [CKEDITOR.event](https://ckeditor.com/docs/ckeditor4/latest/api/CKEDITOR_dom_event.html) support on [Menu](https://ckeditor.com/cke4/addon/menu) plugin. Additionally menu added `hide` event when menu is hidden.
